...
export default function GitWidget3() {
  ...
  <div>  
    ...
    <div className="flex flex-col md:flex-row md:items-start items-center mx-2 mb-44 justify-center mt-10 min-h-screen">
      ...
      <div className="w-full max-w-sm mx-2 my-2 bg-slate-700 rounded-2xl shadow-xl hover:shadow-pink-500 transition-shadow duration-700">
        <div className="flex flex-col items-center bg-gradient-to-r from-sky-500 to-indigo-500 rounded-t-xl">
          ...
          <span className="text-sm text-gray-400 mb-6">{githubData.type}</span>
        </div>
        ...
        <div className="flex flex-col justify-center items-center m-5 space-y-2">
          <div>
            ...
            <a
              ...
              href={githubData.html_url} target="_blank" rel="noopener noreferrer"
            >
              {githubData.login}
            </a>
          </div>
          ...
          <div className="text-sm text-green-400 hover:text-pink-500 mt-2">
            ...
            <a href={twitterLink} target="_blank" rel="noopener noreferrer">{githubData.twitter_username}</a>
          </div>

            <div className="flex flex-row">
          <span className="text-sm text-gray-400 mr-2">Followers:</span>
          <p className="text-violet-500 font-semibold">{githubData.followers}</p>
          </div>
          
          <div className="flex flex-row">
          <span className="text-sm text-gray-400 mr-2">Public Repos:</span>
          <p className="text-orange-500 font-semibold">{githubData.public_repos}</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-sm mx-2 my-2 bg-slate-700 rounded-2xl shadow-xl hover:shadow-violet-500 transition-shadow duration-700">
        <div className="flex flex-col items-center bg-gradient-to-r from-purple-500 to-pink-500 rounded-t-xl">
          ...
          <span className="text-sm text-gray-400 mb-6">{githubData2.type}</span>
        </div>
        ...
        <div className="flex flex-col items-center m-5 space-y-2">
          <div>
            ...
            <a
              ...
              href={githubData2.html_url} target="_blank" rel="noopener noreferrer"
            >
              {githubData2.login}
            </a>
          </div>
          ...
          <div className="text-sm text-green-400 hover:text-pink-500 mt-2">
            <i className="fa-brands fa-twitter mr-1 text-blue-500"></i>
            <a href={twitterLink2} target="_blank" rel="noopener noreferrer">{githubData2.twitter_username}</a>
          </div>

            <div className="flex flex-row">
          <span className="text-sm text-gray-400 mr-2">Followers:</span>
          <p className="text-violet-500 font-semibold">{githubData2.followers}</p>
          </div>
          
          <div className="flex flex-row">
          <span className="text-sm text-gray-400 mr-2">Public Repos:</span>
          <p className="text-orange-500 font-semibold">{githubData2.public_repos}</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-sm mx-2 my-2 bg-slate-700 rounded-2xl shadow-xl hover:shadow-cyan-500 transition-shadow duration-700">
        <div className="flex flex-col items-center bg-gradient-to-r from-violet-500 to-fuchsia-500 rounded-t-xl">
          ...
          <span className="text-sm text-gray-400 mb-6">{githubData3.type}</span>
        </div>
        ...
        <div className="flex flex-col items-center m-5 space-y-2">
          <div>
            ...
            <a
              ...
              href={githubData3.html_url} target="_blank" rel="noopener noreferrer"
            >
              {githubData3.login}
            </a>
          </div>
          ...
          <div className="text-sm text-green-400 hover:text-pink-500 mt-2">
            <i className="fa-brands fa-twitter mr-1 text-blue-500"></i>
            <a href={twitterLink3} target="_blank" rel="noopener noreferrer">{githubData3.twitter_username}</a>
          </div>

            <div className="flex flex-row">
          <span className="text-sm text-gray-400 mr-2">Followers:</span>
          <p className="text-violet-500 font-semibold">{githubData3.followers}</p>
          </div>
          
          <div className="flex flex-row">
          <span className="text-sm text-gray-400 mr-2">Public Repos:</span>
          <p className="text-orange-500 font-semibold">{githubData3.public_repos}</p>
          </div>
        </div>
      </div>
